    ...
    def call(self, func: Callable, *args, **kwargs) -> Any:
        ...
        with self._lock:
            ...
            if self._state == CircuitState.OPEN:
                ...
                logger.info(f"Circuit breaker '{self.name}' is HALF_OPEN - testing service")
    ...
    def _check_state_transition(self, current_time: float) -> None:
        ...
        if self._state == CircuitState.OPEN:
            ...
            if (self._stats.last_failure_time and 
                current_time - self._stats.last_failure_time >= self.timeout):
        ...
        with self._lock:
            for name, breaker in self._breakers.items():
                ...
                breaker_info = {
                    "name": name,
                    "state": state.value,
                    "failure_rate": (stats.failure_count / stats.total_requests 
