"""Direct cache tests to achieve coverage without package import issues."""
...
cache_module_path = '/root/repo/src/lexgraph_legal_rag/cache.py'
models_module_path = '/root/repo/src/lexgraph_legal_rag/models.py'

# Load modules directly
import importlib.util

spec = importlib.util.spec_from_file_location("cache", cache_module_path)
cache_module = importlib.util.module_from_spec(spec)
spec.loader.exec_module(cache_module)

spec_models = importlib.util.spec_from_file_location("models", models_module_path)
models_module = importlib.util.module_from_spec(spec_models)
spec_models.loader.exec_module(models_module)

# Import the classes we need
CacheEntry = cache_module.CacheEntry
LRUCache = cache_module.LRUCache
QueryResultCache = cache_module.QueryResultCache
get_query_cache = cache_module.get_query_cache
configure_cache = cache_module.configure_cache
LegalDocument = models_module.LegalDocument
